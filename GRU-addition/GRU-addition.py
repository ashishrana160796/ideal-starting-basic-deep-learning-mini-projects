...
for epoch in range(5001):
    ...
    if epoch % 500 == 0:
        ...
        plt.ylabel('Loss')
        # plt.show()
        name = 'Fig_'+str(epoch)+'.png'
        path = '' # add required path if any
...
print('Result is given as'+str(y))

# Output: 

#Iteration: 0, train loss: 1.2274, test loss: 1.1549
#Iteration: 500, train loss: 0.6207, test loss: 0.6219
#Iteration: 1000, train loss: 0.5734, test loss: 0.5826
#Iteration: 1500, train loss: 0.3035, test loss: 0.2971
#Iteration: 2000, train loss: 0.0917, test loss: 0.0723
#Iteration: 2500, train loss: 0.0021, test loss: 0.0034
#Iteration: 3000, train loss: 0.0003, test loss: 0.0006
#Iteration: 3500, train loss: 0.0001, test loss: 0.0003
#Iteration: 4000, train loss: 0.0001, test loss: 0.0002
#Iteration: 4500, train loss: 0.0000, test loss: 0.0002
#Iteration: 5000, train loss: 0.0000, test loss: 0.0002
#1026
